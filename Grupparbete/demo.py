...
def word_guessing_game():
  """Ett enkelt ordgissningsspel med en snygg UI."""
  ...
  while True:
    ...
    # Spela spelet med den valda listan med ord.
    play_word_guessing_game(word_list)

def play_word_guessing_game(word_list):
  """Spelar ett ordgissningsspel med en given lista med ord."""
